...
\begin{itemize}
	...
	\item \verb|clust_rand_score()| computes the so-called \emph{adjusted Rand score} between a given predicted clustering and true clustering. This score is a value in $[0,1]$ that represents a measure of the proportion of correct decisions made by the clustering algorithm with respect to the true clustering: the higher the score, the better the estimation. (TODO explaination/source)
\end{itemize}
