...
As for the lower-level operations in \verb|run()|, almost all time spent in \verb|step()| (-> collecting is irrelevant),
more specifically in \verb|sample_allocations()| (33\%)
* \verb|like()| takes a total of 20\% across \verb|run()| and \verb|eval_density()|
times
...
For these reasons, we were not able to run Python tests 7 and 8, which are the equivalent of test 5-6 but in dimensions $d=10$ and $d=20$, on our machines. \\
