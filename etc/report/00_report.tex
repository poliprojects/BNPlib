...
\begin{thebibliography}{9}
	...
	\bibitem{beep-bayes} Course material for Bayesian Statistics by Prof. Guglielmi: \url{https://beep.metid.polimi.it/web/2019-20-bayesian-statistics-alessandra-guglielmi-/}
	
	\bibitem{beep-pacs} Course material for Advanced Programming for Scientific Computing by Prof. Formaggia:
	\url{https://beep.metid.polimi.it/web/102725282}
\end{thebibliography}

\end{document}

% TODO: rerun per vedere se il fix a Neal8::set_n_aux() è corretto
% TODO: turn all bad \verb|| into \texttt{}
