...
write.table(test1, "csv/test/data1.csv", row.names = FALSE, col.names = FALSE)
write.table(true_clust1, "csv/test/true_clust1.csv", row.names = FALSE,
    col.names = FALSE)

# Test 2
test2 = c(rnorm(900, -5, 1), rnorm(100, +5, 1))
true_clust2 = c(rep(0,900), rep(1,100))
write.table(test2, "csv/test/data2.csv", row.names = FALSE, col.names = FALSE)
write.table(true_clust2, "csv/test/true_clust2.csv", row.names = FALSE,
    col.names = FALSE)

# Test 3
test3 = c(rnorm(60, -2, 0.8), rnorm(60, 0, 0.8), rnorm(80, +2, 1))
true_clust3 = c(rep(0,60), rep(1,60), rep(2,80))
write.table(test3, "csv/test/data3.csv", row.names = FALSE, col.names = FALSE)
write.table(true_clust3, "csv/test/true_clust3.csv", row.names = FALSE,
    col.names = FALSE)
...
write.table(test4, "csv/test/data4.csv", row.names = FALSE, col.names = FALSE)
write.table(true_clust4, "csv/test/true_clust4.csv", row.names = FALSE,
    col.names = FALSE)
