...
\begin{frame}
	...
	\begin{thebibliography}{9}
		...
		\bibitem{proto} Protocol Buffers: \texttt{https://developers.google.com/protocol-buffers/} \\
		\texttt{docs/cpptutorial}
		\bibitem{stan} Stan: \texttt{http://mc-stan.org/math}
		\bibitem{eigen} Eigen: \texttt{https://eigen.tuxfamily.org/dox}
