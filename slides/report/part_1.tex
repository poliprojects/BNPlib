...
\begin{equation}
	...
	\end{aligned}
\end{equation}
where $\mathbf{p}=(p_1,\dots,p_K)$ represents the mixing proportions for the clusters and each $\theta_i$ is characterized by the latent cluster $c$ and the corresponding parameters $\phi_{c_i}$.
