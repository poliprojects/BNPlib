...
\subsection{Neal's Algorithm 2} \label{neal2} %TODO
...
Afterwards, the sampler draws a new value for each unique value $\phi_c$ given the data belonging to that class. \\ %TODO how?
