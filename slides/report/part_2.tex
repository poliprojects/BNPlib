% TODO introduce the concept of "chain" and "aux block" somewhere
...
\begin{itemize}
	...
	\end{itemize}
	In particular, we implemented the \verb|HierarchyNNIG| class, which represents the Normal-NIG model described in section \ref{nnig}. %TODO
\end{itemize}
...
In particular, for a Normal-NIG model $m(x)$ is a Student's $t$ as explained in section \ref{nnig}. %TODO reference 
