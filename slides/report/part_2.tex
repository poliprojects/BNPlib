...
\bibitem{integral} Ross, Markwick, \textit{\texttt{dirichletprocess}: An R Package for Fitting Complex Bayesian Nonparametric Models}, found at \url{https://cran.r-project.org/package=dirichletprocess} %TODO change
